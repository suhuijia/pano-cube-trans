...
parser.add_argument('--convert', type=str, default='c2e', choices=['c2e', 'e2c', 'e2p'], help='What convertion to apply.')
parser.add_argument('--i', type=str, default="/Users/a58/workspace/dataset/houseMaterial/esf_images/98422339/result/test/次卧1_o.jpg", help='Path to input image.')
parser.add_argument('--o', type=str, default="/Users/a58/workspace/dataset/houseMaterial/esf_images/98422339/result/test/次卧1_oo.jpg", help='Path to output image.')
parser.add_argument('--w', type=int, default=2048, help='Output width for c2e or e2p. Output cube faces width for e2c.')
parser.add_argument('--h', type=int, default=1024, help='Output height for c2e or e2p.')
